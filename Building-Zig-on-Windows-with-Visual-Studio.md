...
> Note: if cmake complains it can't find the C/CXX compiler(s), you can specify them manually by selecting "Specify native compilers" after clicking "Configure" the first time.  The amd64 C/CXX compiler will probably be here "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin\amd64\cl.exe"
